            ...
            <div className="app-container">
                <div className="dashboard-wrapper">
                    ...
                    <div className="controls-panel">
                        ...
                        {isLive && !isLoading && <span style={{ marginTop: '16px', color: '#24a148', fontWeight: 'bold' }}>Extracted Data</span>}
                        {!isLive && !isLoading && <span style={{ marginTop: '16px', color: '#f1c21b', fontWeight: 'bold' }}>Local Data</span>}
                    </div>
